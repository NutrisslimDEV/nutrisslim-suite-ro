...
require plugin_dir_path(__FILE__) . 'inc/city-validator.php';
...
function enqueue_landing_page_scripts()
{
    ...
    if (is_checkout()) {
        ...
        // Enqueue city autocomplete script and styles
        wp_enqueue_script(
            'city-autocomplete',
            plugins_url('/js/city-autocomplete.js', __FILE__),
            array('jquery'),
            '2.1.0',
            true
        );
        ...
        wp_enqueue_style(
            'city-autocomplete',
            plugins_url('/assets/css/city-autocomplete.css', __FILE__),
            array(),
            '2.1.0'
        );

        // Localize script with nonce and ajax URL
        wp_localize_script('city-autocomplete', 'cityAutocomplete', array(
            'nonce' => wp_create_nonce('romanian_cities_nonce'),
